...
glutInit (&argc, argv);		
glutCreateWindow("Tenorio Malpica Jose Andres. Proyecto1"); //ventana y su nombre Siempre se inicia por apellidos y nombre. para la clase
